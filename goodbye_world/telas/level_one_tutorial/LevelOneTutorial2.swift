...
//
//var opcao_param : OpcaoParametros = OpcaoParametros(nome: "teste", actionHandler: {(para: String) in print(para)}, parametros: ["Guilherme", "Igor", "Arthur"])
//
...
//
//var funcoesTutOne : [Opcao] = [falarOla, opcao_param]
//
